        ...
        Button(
            onClick = {
                if (password == confirmPassword) {
                    ...
                    // In a real app, expose this through the ViewModel. For now, just call signUp.
                    // The error will come from Supabase if passwords don't match, or we can add UI logic.
                }
            },
            modifier = Modifier
                .fillMaxWidth()
